...
<table class="table table-bordered" id="resultTablee" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th style="font-size:14px; color:green;"> Proveedor </th>
			<th style="font-size:14px; color:green;"> Numero de telefono </th>
			<th style="font-size:14px; color:green;"> Dirección </th>
			<th style="font-size:14px; color:green;"> Nombre del viajante </th>
			<th style="font-size:14px; color:green;"> Nota</th>
			<th style="font-size:14px; color:green;" width="120"> Accion </th>
		</tr>
	</thead>
	<tbody>
