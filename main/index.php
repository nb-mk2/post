...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li class="active"><a href="#"><i class="icon-dashboard icon-2x"></i> Inicio </a></li> 
	...
	<div class="contentheader">
			<i class="icon-dashboard"></i> Inicio
			</div>
			<ul class="breadcrumb">
			<li class="active">Inicio</li>
			</ul>
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#E32C29;"><center>Corralon Baudis</center></font>
<div id="mainmain">
...
<a href="corriente.php"><i class="icon-bar-chart icon-2x"></i><br> Cuentas Corriente</a>
