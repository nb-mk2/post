...
$columns = ['transaction_id' , 'name', 'date', 'amount','cuenta', 'invoice_number'];
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td>
        <a href="#" id="'. $row['invoice_number'] .'"  class="delbutton" title="Borrar"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Borrar</button></a>
