...
<center><h4><i class="icon-edit icon-large"></i> Editar Materiales</h4></center>
<hr>
<div id="ac">
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<span>Nombre del Material : </span><input type="text" style="width:231px; height:30px;"  name="code" value="<?php echo $row['product_code']; ?>" Required/><br>
